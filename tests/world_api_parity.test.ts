...
// it lands the matching edit here in the SAME commit. The count pins (197 / 51 / 146)
...
// Partition: 51 `data` + 146 `method` (read-returning + command-void + async).
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 24 facets', () => {
  ...
  it('the union of the 24 facets equals the pinned 197-member IWORLD_MEMBERS set', () => {
