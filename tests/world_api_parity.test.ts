...
// it lands the matching edit here in the SAME commit. The count pins (211 / 58 / 153)
...
// Partition: 58 `data` + 153 `method` (read-returning + command-void + async).
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 26 facets', () => {
  ...
  it('the union of the 26 facets equals the pinned 211-member IWORLD_MEMBERS set', () => {
