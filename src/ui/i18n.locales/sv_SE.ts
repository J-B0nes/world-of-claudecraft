...
export const sv_SE: Partial<Record<TranslationKey, string>> = {
  ...
  'entities.abilities.sport_boot.description':
    'En lång, lyft boll mot siktpunkten. Publiken älskar det.',
  'entities.abilities.sport_boot.name': 'Långboll',
  'entities.abilities.sport_dive.description':
    'Kasta dig mot siktpunkten. En boll i luften fastnar hos dig.',
  'entities.abilities.sport_dive.name': 'Dykning',
  'entities.abilities.sport_feint.description': 'En kvick rusning i sidled mot siktpunkten.',
  'entities.abilities.sport_feint.name': 'Fint',
  'entities.abilities.sport_hoof.description': 'Dundra iväg bollen lågt och hårt framåt i planen.',
  'entities.abilities.sport_hoof.name': 'Rensning',
  'entities.abilities.sport_kick.description': 'Slå bollen längs marken mot siktpunkten.',
  'entities.abilities.sport_kick.name': 'Spark',
  'entities.abilities.sport_pass.description':
    'Rulla en distinkt passning till din valda lagkamrat, lagd i löpvägen.',
  'entities.abilities.sport_pass.name': 'Passning',
  'entities.abilities.sport_punt.description': 'En målvaktsutspark, hög och lång.',
  'entities.abilities.sport_punt.name': 'Utspark',
  ...
  'entities.abilities.sport_shoulder.description':
    'En juste axeltackling i skördefredens anda. Motståndaren tumlar bort från bollen.',
  ...
  'entities.npcs.groundskeeper_bram.greeting':
    'Freden håller på Suggfältet, {className}: bara sparkar och axeltacklingar. Lust att spela om Kopparspannen?',
  'entities.npcs.groundskeeper_bram.name': 'Planskötare Bram',
  'entities.npcs.groundskeeper_bram.title': 'Suggfältets väktare',
  ...
  'guide.professions.archetypeChooseBody':
    'Du utropar din första arketyp genom ett tidigt berättelseuppdrag i zon ett som formellt upptar dig i den identiteten. Innan du har slutfört det uppdraget har du inte valt någon arketyp alls.',
  'guide.professions.archetypeChooseTitle': 'Att välja arketyp',
  'guide.professions.archetypeIdentityBody':
    'Din aktiva arketyp är ett uttalande om vem din karaktär är i världen, och märks i hur andra och världen tilltalar dig. Exakt vilka belöningar och vilket erkännande som följer med håller fortfarande på att slutföras; titta in igen allt eftersom systemet fylls på.',
  'guide.professions.archetypeIdentityTitle': 'Vad din arketyp betyder',
  'guide.professions.archetypeIntro':
    'Vart och ett av de tio hantverken står också för en arketyp, en bredare identitet du kan anta bortom att bara utöva yrket. Din aktiva arketyp är ett enda val i taget, ingen checklista: du bär en, och kan byta till en annan senare om du vill.',
  'guide.professions.archetypeSwitchBody':
    'Att en gång ha utropat en arketyp låser dig inte för alltid. Att byta till en annan arketyp innebär att först slutföra ett upprepningsbart "gottgörelseuppdrag" för din gamla, och för varje byte blir den gottgörelse som förväntas av dig nästa gång lite brantare, så att byten förblir betydelsefulla i stället för kostnadsfria.',
  ...
  'guide.professions.craftComboBody':
    'Utöver ett enskilt hantverks egen receptlista stöder hjulet också kombinationsrecept som kräver två angränsande hantverk på samma gång, vilket belönar en karaktär (eller ett par handelspartner) som har satsat på närliggande yrken på ringen i stället för ett i isolering.',
  ...
  'guide.professions.gatherIntro':
    'Tre insamlingsyrken låter dig hämta råmaterial direkt ur världen: Gruvdrift bryter malm och sten ur ådror, Skogsavverkning fäller timmer ur träddungar och Örtkunskap samlar örter och växter som växer vilt. Vart och ett följs separat: att utöva ett saktar aldrig ner dina framsteg i ett annat.',
  'guide.professions.gatherProficiencyBody':
    'Varje lyckad skörd bygger din skicklighet i det insamlingsyrket. Högre skicklighet vrider det du får ur en fyndighet mot sällsyntare materialkvaliteter, från vanlig och uppåt, även om de allra sällsyntaste kvaliteterna förblir sällsynta också vid hög skicklighet. Mer övning skadar aldrig dina odds, den förbättrar dem bara.',
  'guide.professions.gatherProficiencyTitle': 'Skicklighet och materialkvalitet',
  'guide.professions.gatherTitle': 'Insamling: Gruvdrift, Skogsavverkning och Örtkunskap',
  'guide.professions.gatherToolsBody':
    'Handlare säljer enkla verktyg för varje insamlingsyrke, och bättre kan tillverkas, så att arbetet vid en fyndighet ska kännas allt mer kraftfullt när du rustar dig för det i stället för att stå stilla. Verktyg av högre klass är den tänkta vägen att låsa upp rikare fyndigheter och bearbeta dem effektivare under en lång session.',
  'guide.professions.gatherToolsTitle': 'Yrkets verktyg',
  'guide.professions.gatherWhatBody':
    'Malmådror, träddungar och örtfläckar står utplacerade i zonerna som synliga, oägda inslag. Gå fram till en och interagera med den för att skörda vad den rymmer. När du har skördat en fyndighet behöver den tid att återhämta sig innan just du kan skörda den igen, men den spärrar aldrig någon annan: en annan spelare kan skörda precis samma fyndighet under tiden.',
  'guide.professions.gatherWhatTitle': 'Fyndigheter',
  'guide.professions.intro':
    'Bortom strid och uppdrag belönar världen dig för att bruka jorden och smedjan: samla råmaterial, förvandla dem till utrustning vid tio olika yrkens hantverksstationer och finna dig till rätta i en identitet som en av de tio arketyper yrkena representerar.',
  'guide.valeCupPage.heading': 'Dalcupen',
  'guide.valeCupPage.howHeading': 'Så spelar du',
  'guide.valeCupPage.howMatch':
    'Vid avspark byts din klassuppsättning ut mot en sportuppsättning och återställs exakt efteråt. Sparkar riktas mot marksiktet, bollen studsar mot sargen och att dribbla är helt enkelt att springa med bollen. Gör fler mål än motståndarna före full tid; oavgjort avgörs med gyllene mål.',
  'guide.valeCupPage.howQueue':
    'Köa varifrån som helst via Dalcupsfönstret, eller prata med planskötare Bram vid Suggfältets port. Välj en spelform från en mot en upp till fem mot fem, en banernation och en spelarroll; köa själv eller ta med din grupp.',
  'guide.valeCupPage.howTruce':
    'Ingen blöder på Suggfältet: tacklingar tumlar omkull, inget gör ont och följeslagare sitter över matchen.',
  'guide.valeCupPage.intro':
    'Vildsvinsboll på Suggfältet: välj ett baner, välj en roll och sparka en uppstoppad vildsvinshud förbi en målvakt för att vinna Kopparspannen. Inget blod, inget byte, bara läktarnas vrål.',
  'guide.valeCupPage.loreHeading': 'Vildsvinsboll och skördefreden',
  'guide.valeCupPage.loreOldSow':
    'Långt innan de döda vaknade spelade Östbäcks lantarbetare vildsvinsboll på stubbåkrarna efter skörden: två folkhopar, en vildsvinshud stoppad med halm och två vagnsgrindar släpade till var sin ände av ängen. Den första bollen, Gamla suggan, hänger bronserad ovanför värdshusets härd.',
  'guide.valeCupPage.loreTruce':
    'När Ashen Coliseum började sanktionera krigsspel svarade marskalk Redbrook med något mildare: en stående skördefred på den gamla ängen. Vagnsgrindarna blev målstolpar, ängen fick väggar, läktare och ett namn, Suggfältet, och priset var alltid samma buckliga mjölkspann som segrarna drack ur: Kopparspannen.',
  ...
  'guide.valeCupPage.nationColiseum':
    'Rött och svart med korsade svärd: de spelar som om det fortfarande vore ett krigsspel.',
  ...
  'guide.valeCupPage.nationThornpeak':
    'Isblått och vitt under bergstoppen: säkra på foten och envisa.',
  'guide.valeCupPage.nationVale':
    'Grönt och guld under vetekärven: hemmalaget, lantarbetare ut i fingerspetsarna.',
  'guide.valeCupPage.nationsBody':
    'Varje lag spelar under ett baner. Kaptenen väljer nation, och om båda lagen bär samma baner spelar bortalaget i omvänd färgställning.',
  'guide.valeCupPage.nationsHeading': 'De åtta banernationerna',
  'guide.valeCupPage.rewardsBody':
    'Fredens regler betyder ingen erfarenhet och inget byte: en avgjord match räknas in i ditt facit och på segertavlan, och poäng till dagliga belöningar följer med. Att överge en match bänkar dig en stund, och planskötaren minns.',
  'guide.valeCupPage.rewardsHeading': 'Fredens regler',
  'guide.valeCupPage.rolesBody':
    'Din roll avgör vilken uppsättning du bär med dig ut på planen. Alla sparkar; resten är temperament.',
  'guide.valeCupPage.rolesHeading': 'Spelarroller',
  'guide.valeCupPage.spectateBody':
    'En match i taget spelas på arenan, och vem som helst kan gå fram och titta från läktaren.',
  ...
  'hudChrome.townFocus.hint':
    'Fokuspoäng lägger en bonus ovanpå varje komponents grundutbyte. Komponenter utan fokus ligger kvar på grundnivån.',
  ...
  'hudChrome.vcup.awayNote':
    'Om båda lagen bär samma baner spelar bortalaget i omvänd färgställning.',
  ...
  'hudChrome.vcup.bet.aria': 'Vadslagning på Dalcupsmatchen',
  'hudChrome.vcup.bet.back': 'Satsa på {team}',
  'hudChrome.vcup.bet.closed': 'Vadslagningen är stängd',
  'hudChrome.vcup.bet.closesIn': 'Vaden stänger om {seconds} sek',
  'hudChrome.vcup.bet.collapse': 'Dölj vaden',
  'hudChrome.vcup.bet.expand': 'Visa vaden och satsa',
  ...
  'hudChrome.vcup.bet.oddsLabel': 'Ger',
  'hudChrome.vcup.bet.prize': 'Pott {amount}',
  'hudChrome.vcup.bet.record': 'Spelfacit: {wins}V-{losses}F, {sign}{net}',
  'hudChrome.vcup.bet.refundLog':
    'Vaden ogiltigförklarades, din insats på {amount} betalades tillbaka.',
  'hudChrome.vcup.bet.splitAria': 'Varje lags andel av spelpotten',
  'hudChrome.vcup.bet.title': 'Matchvad',
  'hudChrome.vcup.bet.wonBanner': 'Ditt vad vann!',
  'hudChrome.vcup.bet.wonLog': 'Ditt Dalcupsvad vann: {amount} utbetalades.',
  'hudChrome.vcup.blockNation': 'Välj en banernation först.',
  'hudChrome.vcup.blockNotLeader': 'Endast gruppledaren kan ställa laget i kö.',
  'hudChrome.vcup.blockPartySize': 'Den spelformen kräver en mindre grupp.',
  'hudChrome.vcup.boardEmpty': 'Inga segrare noterade ännu. Kopparspannen väntar.',
  'hudChrome.vcup.boardHeading': 'Segertavlan',
  ...
  'hudChrome.vcup.briefing.rule1':
    'Sparka eller passa in bollen i motståndarmålet för att göra mål.',
  'hudChrome.vcup.briefing.rule2':
    'Först till 5 mål vinner, eller flest mål när matchen blåses av.',
  'hudChrome.vcup.briefing.rule3':
    'Står det lika vid full tid väntar gyllene mål: nästa mål vinner.',
  'hudChrome.vcup.briefing.rule4':
    'Tacklingar får dig bara att tumla omkull. Ingen kommer till skada under skördefreden.',
  'hudChrome.vcup.briefing.rule5': 'Vem som helst kan komma förbi och heja på dig från läktaren.',
  'hudChrome.vcup.briefing.rulesHeading': 'Så spelar du',
  'hudChrome.vcup.briefing.subtitle': 'Genomgång inför matchen',
  'hudChrome.vcup.briefing.vs': 'mot',
  'hudChrome.vcup.briefing.waiting': 'Väntar på att motståndarna ska bli redo...',
  'hudChrome.vcup.briefing.whistle': 'Visselpipan ljuder om {seconds} sek.',
  'hudChrome.vcup.briefing.you': 'Du',
  'hudChrome.vcup.clock': '{minutes}:{seconds}',
  'hudChrome.vcup.close': 'Stäng Dalcupsfönstret',
  'hudChrome.vcup.deserterNote': 'Planskötaren minns. Du kan köa igen om {seconds} sek.',
  'hudChrome.vcup.enterAsGuild': 'Ställ upp under {guild}s baner',
  'hudChrome.vcup.gossipOpen': 'Matchboken',
  'hudChrome.vcup.gossipOpenAria': 'Öppna Dalcupsfönstret',
  'hudChrome.vcup.guildBoardEmpty': 'Inget gille har tagit planen ännu. Hissa ert baner!',
  'hudChrome.vcup.guildBoardHeading': 'Gillesbaner',
  ...
  'hudChrome.vcup.indicatorQueued': 'Dalcupskön: {bracket}, plats {position} av {count}',
  'hudChrome.vcup.leaveQueue': 'Lämna kön',
  'hudChrome.vcup.liveAria': 'Dalcupen: {nationA} {scoreA}, {nationB} {scoreB}',
  'hudChrome.vcup.liveHeading': 'Just nu på Suggfältet',
  ...
  'hudChrome.vcup.logRoster': 'Ditt lag: {allies}. Deras lag: {enemies}.',
  ...
  'hudChrome.vcup.nation.choir': 'Den bleka kören',
  'hudChrome.vcup.nation.coliseum': 'Ashen Coliseum',
  'hudChrome.vcup.nation.copperdig': 'Kopparbrottet',
  'hudChrome.vcup.nation.mirefen': 'Dykärret',
  'hudChrome.vcup.nation.moon': 'Den bleka månen',
  'hudChrome.vcup.nation.ogre': 'Ogreklanerna',
  'hudChrome.vcup.nation.thornpeak': 'Törntoppen',
  'hudChrome.vcup.nation.vale': 'Östbäcksdalen',
  'hudChrome.vcup.nationsHeading': 'Banernation',
  'hudChrome.vcup.noLive': 'Planen ligger tyst. Ingen match spelas.',
  ...
  'hudChrome.vcup.practice': 'Öva mot bottar',
  'hudChrome.vcup.practiceNote': 'Startar direkt en privat botmatch på din egen träningsplan.',
  'hudChrome.vcup.practicingNow': 'Övar just nu ({count}):',
  'hudChrome.vcup.queue': 'Ställ dig i kön',
  'hudChrome.vcup.queueNote': 'Köa varifrån som helst; visselpipan kallar dig till Suggfältet.',
  'hudChrome.vcup.queuedStatus': 'I kö för {bracket}: plats {position} av {count}.',
  'hudChrome.vcup.recordLine': 'Ditt facit: {wins} vinster, {losses} förluster, {draws} oavgjorda.',
  'hudChrome.vcup.role.allrounder.desc':
    'Lite av varje: spark, långboll och en juste axeltackling.',
  'hudChrome.vcup.role.allrounder.name': 'Allroundspelare',
  'hudChrome.vcup.role.keeper.desc': 'Vaktar målområdet med grepp, dykning och utspark.',
  'hudChrome.vcup.role.keeper.name': 'Målvakt',
  'hudChrome.vcup.role.striker.desc': 'Lever för långbollen och den kvicka finten.',
  ...
  'hudChrome.vcup.rolesHeading': 'Spelarroll',
  'hudChrome.vcup.shootPower': 'KRAFT',
  'hudChrome.vcup.title': 'Dalcupen',
  'hudChrome.vcup.waitingCount': '{count} väntar',
  'hudChrome.vcup.walkUp': 'Gå fram till Suggfältet för att titta från läktaren.',
};
